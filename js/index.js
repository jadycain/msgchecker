...
$(document).ready(function () {
  $.ajax({
    url: "https://intersense.ddns.net:9022/api/Message/GetListBlog?lang=EN",
    type: "GET",
    dataType: "json",
    ...
    success: function (data) {
      ...
      for (var i = 0; i < blog_num; i++) {
        ...
        $("section.blog .item_box").append(
          '<a class="item" href="blog.html?aid=' +
            blog_id +
            '">' +
            '<figure><img src="' +
            blog_img +
            '" /><div class="more"><p>Read more</p></div></figure>' +
            '<div class="info"><h3>' +
            blog_title +
            "</h3><h4>" +
            blog_text +
...
function act00() {
  ...
  TweenMax.to("section.kv .inner .left p", 0.8, {
    delay: 0.3,
    opacity: 1,
    x: 0,
  });
  TweenMax.to("section.kv .inner .left a", 0.8, {
    delay: 0.6,
    opacity: 1,
    x: 0,
  });
  ...
  TweenMax.to("section.kv .inner .right .c02", 0.8, {
    delay: 0.5,
    opacity: 1,
    x: 0,
  });
...
function act02() {
  ...
  TweenMax.to("section.trust .inner .info", 0.8, {
    delay: 0.3,
    opacity: 1,
    x: 0,
  });
...
function act03() {
  ...
  TweenMax.to("section.say .inner .item_box", 0.8, {
    delay: 0.6,
    opacity: 1,
    y: 0,
  });
...
function act05() {
  ...
  TweenMax.to("section.blog .inner .item_box", 0.8, {
    delay: 0.5,
    opacity: 1,
    y: 0,
  });
...
function windowScroll() {
  ...
  if (
    winScroll >= $("section.feature").offset().top - winHeight * 0.8 &&
    is_act01 == false
  ) {
    is_act01 = true;
    act01();
  ...
  if (
    winScroll >= $("section.trust").offset().top - winHeight * 0.8 &&
    is_act02 == false
  ) {
    is_act02 = true;
    act02();
  ...
  if (
    winScroll >= $("section.say").offset().top - winHeight * 0.8 &&
    is_act03 == false
  ) {
    is_act03 = true;
    act03();
  ...
  if (
    winScroll >= $("section.whoscall").offset().top - winHeight * 0.8 &&
    is_act04 == false
  ) {
    is_act04 = true;
    act04();
  ...
  if (
    winScroll >= $("section.blog").offset().top - winHeight * 0.8 &&
    is_act05 == false
  ) {
    is_act05 = true;
    act05();
